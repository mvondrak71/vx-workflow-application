/* cobble.c - source for sample VxWorks downloadable kernel application */

/* This code is intentionally left buggy! */

/*
 * Copyright (c) 1999, 2001, 2006, 2014, 2015 Wind River Systems, Inc.
 *
...
--------------------
10aug15,h_k  changed the task ID type from int to TASK_ID for LP64. (F2518)
09oct14,kk   fixed header inclusion to use "<>" instead of """" (V7COR-1009)
01apr06,dlk  Documentation updates.
01apr01,ems  better badness & cripser cleanups (with gracious help of wsl)
01apr99,ems  written (with gracious help of dlk)
*/

/*
DESCRIPTION:
This module is used as a simple example multitask application
in the form of a downloadable VxWorks kernel module.  It is
intended to help the new Wind River Workbench user quickly become
familiar with various tools that are available for debugging such
applications.
